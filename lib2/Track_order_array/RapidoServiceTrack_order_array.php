<?php
/**
 * File for class RapidoServiceTrack_order_array
 * @package Rapido
 * @subpackage Services
 ...
 */
/**
 * This class stands for RapidoServiceTrack_order_array originally named Track_order_array
 * @package Rapido
 * @subpackage Services
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2018-03-09
 */
class RapidoServiceTrack_order_array extends RapidoWsdlClass
{
    /**
     ...
     * @return Array
     */
    public function track_order_array($_loginparam,$_tarray)
    {
        try
        {
