<?php
/**
 * File for RapidoWsdlClass to communicate with SOAP service
 * @package Rapido
 ...
 */
/**
 * RapidoWsdlClass to communicate with SOAP service
 * 
 * @package Rapido
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2018-03-09
 */
class RapidoWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
    ...
    /**
     * Constructor
     * @uses RapidoWsdlClass::setLastError()
     * @uses RapidoWsdlClass::initSoapClient()
     * @uses RapidoWsdlClass::initInternArrayToIterate()
     * @uses RapidoWsdlClass::_set()
    ...
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'RapidoWsdlClass'))
            {
     ...
     * @uses RapidoClassMap::classMap()
     * @uses RapidoWsdlClass::getDefaultWsdlOptions()
     * @uses RapidoWsdlClass::getSoapClientClassName()
     * @uses RapidoWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('RapidoClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = RapidoClassMap::classMap();
     ...
     * If a class is named as {Rapido}SoapClient, then this is the class that will be used.
     ...
     * @uses RapidoWsdlClass::WSDL_CACHE_WSDL
     * @uses RapidoWsdlClass::WSDL_COMPRESSION
     * @uses RapidoWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses RapidoWsdlClass::WSDL_ENCODING
     * @uses RapidoWsdlClass::WSDL_EXCEPTIONS
     * @uses RapidoWsdlClass::WSDL_FEATURES
     * @uses RapidoWsdlClass::WSDL_LOGIN
     * @uses RapidoWsdlClass::WSDL_PASSWORD
     * @uses RapidoWsdlClass::WSDL_SOAP_VERSION
     * @uses RapidoWsdlClass::WSDL_STREAM_CONTEXT
     * @uses RapidoWsdlClass::WSDL_TRACE
     * @uses RapidoWsdlClass::WSDL_TYPEMAP
     * @uses RapidoWsdlClass::WSDL_URL
     * @uses RapidoWsdlClass::VALUE_WSDL_URL
     * @uses RapidoWsdlClass::WSDL_USER_AGENT
     * @uses RapidoWsdlClass::WSDL_PROXY_HOST
     * @uses RapidoWsdlClass::WSDL_PROXY_PORT
     * @uses RapidoWsdlClass::WSDL_PROXY_LOGIN
     * @uses RapidoWsdlClass::WSDL_PROXY_PASSWORD
     * @uses RapidoWsdlClass::WSDL_LOCAL_CERT
     * @uses RapidoWsdlClass::WSDL_PASSPHRASE
     * @uses RapidoWsdlClass::WSDL_AUTHENTICATION
     * @uses RapidoWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses RapidoWsdlClass::getSoapClient()
     * @uses RapidoWsdlClass::getFormatedXml()
     ...
     * @uses RapidoWsdlClass::getSoapClient()
     * @uses RapidoWsdlClass::convertStringHeadersToArray()
     ...
     * @uses RapidoWsdlClass::getInternArrayToIterate()
     * @uses RapidoWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses RapidoWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses RapidoWsdlClass::getInternArrayToIterateOffset()
     * @uses RapidoWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses RapidoWsdlClass::getInternArrayToIterateOffset()
     * @uses RapidoWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @uses RapidoWsdlClass::getAttributeName()
     * @uses RapidoWsdlClass::__toString()
     * @uses RapidoWsdlClass::_set()
     * @uses RapidoWsdlClass::_get()
     * @uses RapidoWsdlClass::setInternArrayToIterate()
     * @uses RapidoWsdlClass::setInternArrayToIterateIsArray()
     * @uses RapidoWsdlClass::setInternArrayToIterateOffset()
