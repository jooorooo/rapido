<?php
/**
 * File for class RapidoServiceTrack_order
 * @package Rapido
 * @subpackage Services
 ...
 */
/**
 * This class stands for RapidoServiceTrack_order originally named Track_order
 * @package Rapido
 * @subpackage Services
 * @author Georgi Nachev <jooorooo@gmail.com>
 * @version 20150429-01
 * @date 2018-03-09
 */
class RapidoServiceTrack_order extends RapidoWsdlClass
{
    /**
     ...
     * @return array
     */
    public function track_order($_loginparam,$_nomer)
    {
        try
        {
